...
namespace DDApp.API.Migrations
{
    ...
    [Migration("20230103174325_pushToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDApp.DAL.Entites.DirectDir.DirectImages", b =>
                {
                    b.HasBaseType("DDApp.DAL.Entites.Attach");
            ...
            modelBuilder.Entity("DDApp.DAL.Entites.DirectDir.DirectImages", b =>
                {
                    b.HasOne("DDApp.DAL.Entites.Direct", "DirectImg")
                        .WithOne("DirectImage")
                        .HasForeignKey("DDApp.DAL.Entites.DirectDir.DirectImages", "DirectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DDApp.DAL.Entites.Attach", null)
                        .WithOne()
                        .HasForeignKey("DDApp.DAL.Entites.DirectDir.DirectImages", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
